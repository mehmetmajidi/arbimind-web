...
export default function ConfirmPlaceOrderModal({
    isOpen,
    onClose,
    onConfirm,
    orderDetails,
}: ConfirmPlaceOrderModalProps) {
    // Close on Escape key
    useEffect(() => {
    ...
    const [base, quote] = orderDetails.symbol.split("/");
            ...
            >
                ...
                >
                    ...
                    >
                        ...
                        <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
                            <span style={{ color: "#ffffff", fontSize: "13px", fontWeight: "500" }}>
                                {orderDetails.orderType.charAt(0).toUpperCase() + orderDetails.orderType.slice(1)}
                            </span>
                            <span style={{ color: "#888" }}>→</span>
                            <span
                                style={{
                                    color: orderDetails.side === "buy" ? "#22c55e" : "#ef4444",
                                    fontSize: "13px",
                                    fontWeight: "500",
                                }}
                            >
                                {orderDetails.side.charAt(0).toUpperCase() + orderDetails.side.slice(1)}
                            </span>
                        </div>
                    </div>
                    ...
                    {orderDetails.price && (
                        ...
                        >
                            ...
                            <span style={{ color: "#ffffff", fontSize: "13px", fontWeight: "500" }}>
                                {formatPrice(orderDetails.price)} {quote}
                            </span>
                        </div>
                    )}
                    ...
                    >
                        ...
                        <span style={{ color: "#ffffff", fontSize: "13px", fontWeight: "500" }}>
                            {formatNumber(orderDetails.quantity)} {base}
                        </span>
                    </div>
                    ...
                    {orderDetails.total && (
                        ...
                        >
                            ...
                            <span style={{ color: "#ffffff", fontSize: "13px", fontWeight: "500" }}>
                                {formatPrice(orderDetails.total)} {quote}
                            </span>
                        </div>
                    )}
                </div>
                ...
                <div style={{ display: "flex", gap: "12px", justifyContent: "flex-end" }}>
                    ...
                    <button
                        ...
                        style={{
                            padding: "10px 24px",
                            backgroundColor: orderDetails.side === "buy" ? "#22c55e" : "#ef4444",
                            color: "#ffffff",
                            border: "none",
                            borderRadius: "6px",
                            fontSize: "14px",
                        ...
                        onMouseEnter={(e) => {
                            e.currentTarget.style.backgroundColor = orderDetails.side === "buy" ? "#16a34a" : "#dc2626";
                        }}
                        onMouseLeave={(e) => {
                            e.currentTarget.style.backgroundColor = orderDetails.side === "buy" ? "#22c55e" : "#ef4444";
                        }}
                    >
                        Place Order
                    </button>
